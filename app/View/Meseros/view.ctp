...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Mesero'), array('action' => 'delete', $mesero['Mesero']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $mesero['Mesero']['id']))); ?> </li>
